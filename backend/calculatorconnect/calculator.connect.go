...
import (
	calculator "calculator-project/backend/gen/calculator"
...
type CalculatorServiceClient interface {
	Calculate(context.Context, *connect.Request[calculator.CalculationRequest]) (*connect.Response[calculator.CalculationResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CalculatorServiceClient {
	...
	calculatorServiceMethods := calculator.File_calculator_proto.Services().ByName("CalculatorService").Methods()
	return &calculatorServiceClient{
		calculate: connect.NewClient[calculator.CalculationRequest, calculator.CalculationResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect.Client[calculator.CalculationRequest, calculator.CalculationResponse]
}

// Calculate calls calculator.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect.Request[calculator.CalculationRequest]) (*connect.Response[calculator.CalculationResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect.Request[calculator.CalculationRequest]) (*connect.Response[calculator.CalculationResponse], error) {
